...
/datum/map/isolation/get_map_info()
	. = list()
	. += "You're aboard the <b>[station_name],</b> an old but reliable frontier exploration ship owned by Xion Industries sent out to locate new mining hotspots and test experimental equipment."
...
/datum/map/isolation/send_welcome()
	...
	welcome_text += "Current Coordinates:<br /><b>[torch.x]:[torch.y]</b><br /><br>"//torch.x and torch.y work, so I guess we're using them
