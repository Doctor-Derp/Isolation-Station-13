...
/datum/job/amanager
	...
	access = list(access_XIV, access_bridge, access_medical, access_engine_equip, access_tcomsat, access_network, access_engine, access_atmospherics, access_research, access_robotics, access_external_airlocks)
	minimal_access = list()
...
/datum/job/senior_engineer
	...
	access = list(access_XIV, access_engine_equip, access_tcomsat, access_network, access_engine, access_atmospherics, access_robotics, access_external_airlocks)
...
/datum/job/engineer
	...
	access = list(access_XIV, access_engine_equip, access_engine, access_atmospherics, access_robotics, access_external_airlocks)
